...
if ($Project->getConfig('templateTailwindCss.settings.navBarMainColor')) {
    $navBarMainColor = $Project->getConfig('templateTailwindCss.settings.navBarMainColor');
}

if ($Project->getConfig('templateTailwindCss.settings.navBarFontColor')) {
    $navBarFontColor = $Project->getConfig('templateTailwindCss.settings.navBarFontColor');
}

if ($Project->getConfig('templateTailwindCss.settings.mobileFontColor')) {
    $mobileFontColor = $Project->getConfig('templateTailwindCss.settings.mobileFontColor');
}

if ($Project->getConfig('templateTailwindCss.settings.mobileMenuBackground')) {
    $mobileMenuBackground = $Project->getConfig('templateTailwindCss.settings.mobileMenuBackground');
}
...
if ($Project->getConfig('templateTailwindCss.settings.colorFooterBackground')) {
    $colorFooterBackground = $Project->getConfig('templateTailwindCss.settings.colorFooterBackground');
}

if ($Project->getConfig('templateTailwindCss.settings.colorFooterFont')) {
    $colorFooterFont = $Project->getConfig('templateTailwindCss.settings.colorFooterFont');
}

if ($Project->getConfig('templateTailwindCss.settings.colorMain')) {
    $colorMain = $Project->getConfig('templateTailwindCss.settings.colorMain');
}

if ($Project->getConfig('templateTailwindCss.settings.buttonFontColor')) {
    $buttonFontColor = $Project->getConfig('templateTailwindCss.settings.buttonFontColor');
}

if ($Project->getConfig('templateTailwindCss.settings.colorFooterLinks')) {
    $colorFooterLinks = $Project->getConfig('templateTailwindCss.settings.colorFooterLinks');
}

if ($Project->getConfig('templateTailwindCss.settings.colorMainContentBg')) {
    $colorMainContentBg = $Project->getConfig('templateTailwindCss.settings.colorMainContentBg');
}
...
$headerHeight = $Project->getConfig('templateTailwindCss.settings.headerHeight');
$headerHeightValue = (int)$Project->getConfig('templateTailwindCss.settings.headerHeightValue');
$bgColorSwitcherPrefix = $Project->getConfig('templateTailwindCss.settings.bgColorSwitcherPrefix');
$bgColorSwitcherSuffix = $Project->getConfig('templateTailwindCss.settings.bgColorSwitcherSuffix');
$headerImagePosition = $Project->getConfig('templateTailwindCss.settings.headerImagePosition');
